...
const defaultItems = [
    { letter: "C", icon: <FaGithub />, label: "Github", href: "https://github.com/arpan-bhavsar" },
    { letter: "O", icon: <FaTwitter />, label: "Twitter", href: "https://x.com/ArpanBhavsar_" },
    { letter: "N", icon: <FaLinkedin />, label: "LinkedIn", href: "https://www.linkedin.com/in/arpan-bhavsar-profile/" },
    { letter: "T", icon: <FaInstagram />, label: "Instagram", href: "https://www.instagram.com/arpan_j_bhavsar/" },
    { letter: "A", icon: <SiLeetcode />, label: "LeetCode", href: "https://leetcode.com/u/CECSE5_24SE09CS007/" },
    { letter: "C", icon: <FaEnvelope />, label: "Email", href: "https://mail.google.com/mail/?view=cm&fs=1&to=arpanjbhavsar123@gmail.com" },
    { letter: "T", icon: <FaDiscord />, label: "Discord", href: "https://discord.com/users/917057043037290538" },
];
